...
# give clusters meaning: business labels
cluster_names = {0:"Commodity light shippers", 1:"Volume giants", 2:"Heavy shippers", 3:"Mega shippers", 4:"Premium shippers"}
...
with tab2:
    ...
    if show_forecast:
        ...
        fig.add_trace(go.Scatter(x=fc.PERIOD, y=fc.Revenue_forecast_EUR, name="Forecast", line=dict(color="#888", dash='dash')))
...
with tab3:
    ...
    st.markdown("""
    **How to read this:**
    - **Volume giants** — huge numbers of light, low-value parcels (Zalando, Inditex)
    - **Commodity light shippers** — light, low-value parcels (Nestlé, Sephora, GXO)
    - **Premium shippers** — light parcels but high value (LVMH, Chanel, Apple)
    - **Heavy shippers** — heavy parcels (Carrefour, Gousto, Makita, Hachette)
    - **Mega shippers** — exceptional volume and weight (HelloFresh, Zooplus)
    """)
