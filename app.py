...
def load():
    ...
    clf = pd.read_csv('classification-temp.csv', sep=';')
...
cluster_names = {0:"Volume giants", 1:"Commodity light shippers", 2:"Heavy shippers",3:"Mega shippers", 4:"Premium shippers"}
